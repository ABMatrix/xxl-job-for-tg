...
public class JobApiController {
	...
	public ReturnT<String> api(HttpServletRequest request, @PathVariable("uri") String uri,
		...
		if (XxlJobAdminConfig.getAdminConfig().getAccessToken() != null
			...
			String localToken = XxlJobAdminConfig.getAdminConfig().getAccessToken();
			String tokenParam = request.getHeader(XxlJobRemotingUtil.XXL_JOB_ACCESS_TOKEN);
			String message = StrUtil.format("The access token is wrong.The local token is{},But the remote token is{}",
					localToken, tokenParam);
